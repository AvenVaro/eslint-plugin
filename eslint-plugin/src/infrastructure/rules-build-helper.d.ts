...
export interface RulesBuildHelper {
   ...
   *
   * @returns A strictly formatted JSON Schema object representing the disabled state constraint.
   */
  createDisablePropertySchema(property?: JSONSchema4): JSONSchema4;
